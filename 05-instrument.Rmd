...
```{r instplot, warning=FALSE, message=FALSE,fig.cap='Monthly carbon policy surprise series and some policy events that produced substantial market reactions. The dashed line deliniates between the policy surprise produced by \\citet{kaenzig2022} and the author.'}
