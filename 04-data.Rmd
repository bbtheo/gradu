...
```{r unemptrend, warning=FALSE, echo=FALSE,message=FALSE, fig.cap ='Monthly observed unemployment rate and the seasonally adjusted trend values of unemployment rate in Finland.  The Data is from the '}
...
```{r indtrend, warning=FALSE, echo=FALSE,message=FALSE, fig.cap ='Monthly observed industrial production index and the seasonally adjusted trend values of industrial output in Finland.  The Data is from the '}
