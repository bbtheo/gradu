...
```{r energy-share, warning=FALSE, message=FALSE, fig.cap = 'Monthly energy production in Finland by energy source. The increased share of renewable energy production and decreased total energy production  have been the prevalent trends after the year 2010.'}
