...
```{r price-evolution,echo=FALSE,message=FALSE,fig.cap="The evolution of the EU Emission trading system spot price and different future lengths prices through the different phases of the system. 2.0. Data was sourced from Datastream, as is identified in Appendix \\@ref(datasaources)"}
