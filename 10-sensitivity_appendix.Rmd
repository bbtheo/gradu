...
```{r include-sens-irf1, fig.cap='The IRFs with my seasonally agressively varying GHG emissions and with the not seasonally adjusted unemployment rates as endogenous variables.'}
...
```{r include-sens-irf2, fig.cap= 'Omitting the Greenhouse gas data from my endogenous variables'}
